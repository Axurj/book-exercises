...
ggplot(data = diamonds_sample) +
  geom_point(mapping = aes(x = carat, y = cut, size = price),color = "blue")
...
ggplot(data = diamonds_sample) +
  geom_col(mapping = aes(x = carat, y = price, color = "orange"), alpha = 0.3) +
  geom_smooth(mapping = aes(x = cut, y = price), color = "purple", alpha = 0.3)
